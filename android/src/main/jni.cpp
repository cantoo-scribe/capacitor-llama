...
Java_com_capllama_LlamaContext_modelInfo(
    JNIEnv *env,
    jobject thiz,
...
Java_com_capllama_LlamaContext_getBackendDevicesInfo(
    JNIEnv *env,
    jobject thiz
) {
    UNUSED(thiz);
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_initContext(
    JNIEnv *env,
    jobject thiz,
    jobject params_map,
    ...
    if (is_model_loaded) {
        if (embedding && llama_model_has_encoder(llama->model) && llama_model_has_decoder(llama->model)) {
            ...
            writablemap::putString(env, error_result, "_error", "Computing embeddings in encoder-decoder models is not supported");
            return error_result;
        }
        ...
        delete llama;
        auto error_result = writablemap::createWriteableMap(env);
        writablemap::putString(env, error_result, "_error", "Failed to load model");
        return error_result;
    }
...
Java_com_capllama_LlamaContext_interruptLoad(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_loadModelDetails(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
    ...
    writablemap::putDouble(env, result, "nVocab", n_vocab);
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_getFormattedChatWithJinja(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring messages,
    ...
    try {
        ...
        LOGI("[CapLlama] JSON parse error: %s", e.what());
        ...
        LOGI("[CapLlama] Invalid argument: %s", e.what());
        ...
        LOGI("[CapLlama] Runtime error: %s", e.what());
    } catch (const std::exception& e) {
        ...
        LOGI("[CapLlama] C++ exception: %s", e.what());
    }
...
JNIEXPORT jstring JNICALL
Java_com_capllama_LlamaContext_getFormattedChat(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring messages,
    ...
    try {
        auto llama = context_map[(long) context_ptr];
        if (!llama) {
            LOGI("[CapLlama] Error: Context pointer %ld not found in context_map", (long) context_ptr);
        ...
        LOGI("[CapLlama] JSON parse error in getFormattedChat: %s", e.what());
        std::string errorMessage = "JSON parse error in getFormattedChat: " + std::string(e.what());
        env->ThrowNew(env->FindClass("java/lang/RuntimeException"), errorMessage.c_str());
        return nullptr;
    } catch (const std::invalid_argument& e) {
        LOGI("[CapLlama] Invalid argument in getFormattedChat: %s", e.what());
        std::string errorMessage = "Invalid argument in getFormattedChat: " + std::string(e.what());
        env->ThrowNew(env->FindClass("java/lang/IllegalArgumentException"), errorMessage.c_str());
        return nullptr;
    } catch (const std::runtime_error& e) {
        LOGI("[CapLlama] Runtime error in getFormattedChat: %s", e.what());
        std::string errorMessage = "Runtime error in getFormattedChat: " + std::string(e.what());
        env->ThrowNew(env->FindClass("java/lang/RuntimeException"), errorMessage.c_str());
        return nullptr;
    } catch (const std::exception& e) {
        LOGI("[CapLlama] C++ exception in getFormattedChat: %s", e.what());
        std::string errorMessage = "C++ exception in getFormattedChat: " + std::string(e.what());
        env->ThrowNew(env->FindClass("java/lang/RuntimeException"), errorMessage.c_str());
        return nullptr;
    }
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_loadSession(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring path
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_saveSession(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring path,
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_doCompletion(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jobject params,
    ...
    while (llama->completion->has_next_token && !llama->completion->is_interrupted) {
        ...
        if (
            ...
            jmethodID onPartialCompletion = env->GetMethodID(cb_class, "onPartialCompletion", "(Lcom/getcapacitor/JSObject;)V");
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_stopCompletion(
...
Java_com_capllama_LlamaContext_isPredicting(
        JNIEnv *env, jobject thiz, jlong context_ptr) {
    UNUSED(env);
    UNUSED(thiz);
    auto llama = context_map[(long) context_ptr];
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_tokenize(
...
JNIEXPORT jstring JNICALL
Java_com_capllama_LlamaContext_detokenize(
...
Java_com_capllama_LlamaContext_getVocab(
    ...
    for (int i = 0; i < n_vocab; ++i) {
        ...
        writablearray::pushString(env, result, piece.c_str());
    }
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_embedding(
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_rerank(
        JNIEnv *env, jobject thiz,
        jlong context_ptr,
        jstring query,
...
JNIEXPORT jstring JNICALL
Java_com_capllama_LlamaContext_bench(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jint pp,
...
Java_com_capllama_LlamaContext_applyLoraAdapters(
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_removeLoraAdapters(
    JNIEnv *env, jobject thiz, jlong context_ptr) {
    UNUSED(env);
    UNUSED(thiz);
    auto llama = context_map[(long) context_ptr];
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_getLoadedLoraAdapters(
    JNIEnv *env, jobject thiz, jlong context_ptr) {
    UNUSED(thiz);
    auto llama = context_map[(long) context_ptr];
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_freeContext(
        JNIEnv *env, jobject thiz, jlong context_ptr) {
    UNUSED(env);
    UNUSED(thiz);
    auto llama = context_map[(long) context_ptr];
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_setupLog(JNIEnv *env, jobject thiz, jobject logCallback) {
    UNUSED(thiz);
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_unsetLog(JNIEnv *env, jobject thiz) {
    UNUSED(env);
    UNUSED(thiz);
...
JNIEXPORT jboolean JNICALL
Java_com_capllama_LlamaContext_initMultimodal(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring mmproj_path,
...
JNIEXPORT jboolean JNICALL
Java_com_capllama_LlamaContext_isMultimodalEnabled(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_getMultimodalSupport(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_releaseMultimodal(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jboolean JNICALL
Java_com_capllama_LlamaContext_initVocoder(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_releaseVocoder(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_clearCache(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jboolean clear_data
...
JNIEXPORT jboolean JNICALL
Java_com_capllama_LlamaContext_isVocoderEnabled(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_getFormattedAudioCompletion(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_getAudioCompletionGuideTokens(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring text_to_speak
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_decodeAudioTokens(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jintArray tokens
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_enableParallelMode(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jint n_parallel,
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_startProcessingLoop(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_stopProcessingLoop(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_updateSlots(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr
) {
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_doQueueCompletion(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jobject params_map,
    ...
    try {
        ...
        auto on_token = [cb_ctx, llama](const rnllama::completion_token_output& token_output) {
            ...
            jmethodID onPartialMethod = env_cb->GetMethodID(callbackClass, "onPartialCompletion", "(Lcom/getcapacitor/JSObject;)V");
            if (onPartialMethod) {
        ...
        auto on_complete = [cb_ctx, llama](rnllama::llama_rn_slot* slot) {
            ...
            jmethodID onCompleteMethod = env_cb->GetMethodID(callbackClass, "onComplete", "(Lcom/getcapacitor/JSObject;)V");
            if (onCompleteMethod) {
...
JNIEXPORT void JNICALL
Java_com_capllama_LlamaContext_doCancelRequest(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jint request_id
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_doQueueEmbedding(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring text,
...
JNIEXPORT jobject JNICALL
Java_com_capllama_LlamaContext_doQueueRerank(
    JNIEnv *env,
    jobject thiz,
    jlong context_ptr,
    jstring query,
