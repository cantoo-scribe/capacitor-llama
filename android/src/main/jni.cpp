...
// rnllama
static void capllama_log_callback_default(lm_ggml_log_level level, const char * fmt, void * data) {
...
// Method to create JSObject
// static inline jobject createJSObject(JNIEnv *env) {
//     jclass jsObjectClass = env->FindClass("com/getcapacitor/JSObject");
//     jmethodID constructor = env->GetMethodID(jsObjectClass, "<init>", "()V");
//     jobject jsObject = env->NewObject(jsObjectClass, constructor);
//     return jsObject;
...
static inline void putInt(JNIEnv *env, jobject map, const char *key, int value) {
    jclass mapClass = env->FindClass("com/getcapacitor/JSObject");
    jmethodID putIntMethod = env->GetMethodID(mapClass, "put", "(Ljava/lang/String;I)Lcom/getcapacitor/JSObject;");
...
static inline void putDouble(JNIEnv *env, jobject map, const char *key, double value) {
    jclass mapClass = env->FindClass("com/getcapacitor/JSObject");
    jmethodID putDoubleMethod = env->GetMethodID(mapClass, "put", "(Ljava/lang/String;D)Lcom/getcapacitor/JSObject;");
...
static inline void putBoolean(JNIEnv *env, jobject map, const char *key, bool value) {
    jclass mapClass = env->FindClass("com/getcapacitor/JSObject");
    jmethodID putBooleanMethod = env->GetMethodID(mapClass, "put", "(Ljava/lang/String;Z)Lcom/getcapacitor/JSObject;");
...
static inline void putMap(JNIEnv *env, jobject map, const char *key, jobject value) {
    jclass mapClass = env->FindClass("com/getcapacitor/JSObject");
    jmethodID putMapMethod = env->GetMethodID(mapClass, "put", "(Ljava/lang/String;Ljava/lang/Object;)Lcom/getcapacitor/JSObject;");

    jstring jKey = env->NewStringUTF(key);

    // env->CallVoidMethod(map, putMapMethod, jKey, value);
    env->CallObjectMethod(map, putMapMethod, jKey, value);
}
...
static inline jobject createWritableArray(JNIEnv *env) {
    ...
    // return map;
    jclass jsObjectClass = env->FindClass("com/getcapacitor/JSArray");
    jmethodID constructor = env->GetMethodID(jsObjectClass, "<init>", "()V");
    jobject jsObject = env->NewObject(jsObjectClass, constructor);
    return jsObject;
}
...
static inline void putArray(JNIEnv *env, jobject map, const char *key, jobject value) {
    jclass mapClass = env->FindClass("com/getcapacitor/JSObject");
    jmethodID putArrayMethod = env->GetMethodID(mapClass, "put", "(Ljava/lang/String;Ljava/lang/Object;)Lcom/getcapacitor/JSObject;");

    jstring jKey = env->NewStringUTF(key);

    // env->CallVoidMethod(map, putArrayMethod, jKey, value);
    env->CallObjectMethod(map, putArrayMethod, jKey, value);
}
...
JNIEXPORT jboolean JNICALL
Java_com_capllama_LlamaContext_isEmbeddingEnabled(
        JNIEnv *env, jobject thiz, jlong context_ptr) {
    UNUSED(env);
    UNUSED(thiz);
    auto llama = context_map[(long) context_ptr];
...
static void capllama_log_callback_to_j(lm_ggml_log_level level, const char * text, void * data) {
    auto level_c = "";
...
Java_com_capllama_LlamaContext_setupLog(JNIEnv *env, jobject thiz, jobject logCallback) {
    ...
    llama_log_set(capllama_log_callback_to_j, cb_ctx);
}
...
Java_com_capllama_LlamaContext_unsetLog(JNIEnv *env, jobject thiz) {
    UNUSED(env);
    UNUSED(thiz);
    llama_log_set(capllama_log_callback_default, NULL);
}
