...
// WritableMap and WritableArray utilities with cached class references for Capacitor
...
// Global references to Capacitor JSObject/JSArray classes (cached during initialization)
namespace internal {
    static jclass g_JSObjectClass = nullptr;
    static jmethodID g_JSObjectCtor = nullptr;
    static jclass g_JSArrayClass = nullptr;
    static jmethodID g_JSArrayCtor = nullptr;
    ...
    static jmethodID g_putObjectMethod = nullptr;
    ...
    static jmethodID g_pushObjectMethod = nullptr;
}
...
inline int size(JNIEnv *env, jobject readableArray) {
    ...
    jmethodID sizeMethod = env->GetMethodID(arrayClass, "length", "()I");
...
inline jobject getArray(JNIEnv *env, jobject readableMap, const char *key) {
    jclass mapClass = env->GetObjectClass(readableMap);
    jmethodID getArrayMethod = env->GetMethodID(mapClass, "getJSONArray", "(Ljava/lang/String;)Lorg/json/JSONArray;");
    jstring jKey = env->NewStringUTF(key);
